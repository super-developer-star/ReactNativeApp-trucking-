    ...
    (!this.state.isTokenPresent)?
        (<View style={commonStyle.container}>
            <View style={[commonStyle.subContainer,commonStyle.contentCenter]}>
                ...
                :
                    <View style={commonStyle.contentCenter}>
                        <TouchableHighlight onPress={() => navigate('DocType')} underlayColor={common.tuchableUnderlayGreenColor} style={[styles.btnLogin,commonStyle.contentCenter,{backgroundColor:common.greenColor,bottom:107}]}>
